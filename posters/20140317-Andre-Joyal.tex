...
{\scalefont{3.6}{\bf Andre Joyal}}\\\vspace{20pt} {\scalefont{2}of Université du Québec à Montréal will be speaking on}\\\vspace{30pt} {\scalefont{3.6}
    Categorical Homotopy Type Theory
}\\\vspace{20pt} {\scalefont{2}on March 17 at 4:30 
...
\begin{fitbox}{0.9\textwidth}{11.5cm}
 We show that Homotopy Type Theory can be formulated in the language of category theory.
