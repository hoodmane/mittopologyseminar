...
{\scalefont{3.6}{\bf Test Speaker}}\\\vspace{20pt} {\scalefont{2}of MIT will be speaking on}\\\vspace{30pt} {\scalefont{3.6}
    A newwwaa title
}\\\vspace{20pt} {\scalefont{2}on July 31 at 4:30 
...
An abstract  with $some math$ that is new 
\end{fitbox}
