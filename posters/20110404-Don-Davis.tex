...
{\scalefont{3.6}{\bf Don Davis}}\\\vspace{20pt} {\scalefont{2}of Lehigh University will be speaking on}\\\vspace{30pt} {\scalefont{3.6}
...
We use the spectrum tmf to obtain new nonimmersion results
