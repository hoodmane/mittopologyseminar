...
{\scalefont{3.6}{\bf Matilde Marcolli}}\\\vspace{20pt} {\scalefont{2}of CalTech will be speaking on}\\\vspace{30pt} {\scalefont{3.6}
    Feynman integrals, singular hypersurfaces, and motives
...
I will describe different recent approaches to the renormalization and 
