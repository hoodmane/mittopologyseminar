...
# notes: if you have a speaker, you must have an institution for the speaker
# all talks must have a date, and they must all be distinct
# abstracts cannot contain the character '@'
# requirements: python 2.5, 
# can only handle talks that end before 7pm; all talks are 1.5 hours long
...
raw = template.substitute(dict(upcoming=upcoming))
